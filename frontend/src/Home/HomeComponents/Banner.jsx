...
const Banner = () => {
  return (
    <div className="px-4 -mt-4 lg:px-24 bg-teal-100 flex items-center w-full h-screen">
      <div className="flex flex-col md:flex-row justify-evenly items-center gap-12">
        ...
        <img className="md:w-1/2 self-end object-cover" src={svg} alt="Driving school students practicing" />
      </div>
    </div>
  );
};
